...
| Candidate 04 | `assets/ai_assembled_candidate_04_feature_driven.png` | Feature-driven full-face AI candidate |
| Review sheet | `assets/feature_pack_vs_candidate_04_review.jpg` | Side-by-side check: feature pack vs candidate 04 |
...
4. Use the `imagegen` skill with a hard-constrained prompt to generate a full-face candidate.
5. Review whether the candidate actually preserves mouth, philtrum, nose, eye, cheek, and skin cues from the feature pack.
...
Candidate 04 is better than candidate 03 because it uses the mouth, philtrum, and nose slices more visibly. It is still not final:
